...
A Premium registry with a system-assigned identity, zone redundancy, a georeplication to a second region, a retention policy, and the export and quarantine policies set.
